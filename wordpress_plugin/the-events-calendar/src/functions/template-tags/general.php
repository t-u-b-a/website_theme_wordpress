...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	...
	function tribe_events_event_schedule_details( $event = null, $before = '', $after = '' ) {
		...
		$datetime_separator       = '<span class="at">' . tribe_get_option( 'dateTimeSeparator', ' @ ' ) . '</span><span class="from">';
		$time_range_separator     = '</span><span class="to">' . tribe_get_option( 'timeRangeSeparator', ' - ' ) . '</span>';
